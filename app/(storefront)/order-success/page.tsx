    ...
    <section className="section">
      <div className="container-page max-w-3xl">
        <Card className="grid place-items-center p-8 text-center md:p-12">
          ...
          <p className="mt-4 text-gray-600">Tiembac.vn sẽ liên hệ xác nhận và chuẩn bị gói quà thật chỉn chu cho bạn.</p>
          <div className="mt-6 grid w-full gap-3 rounded-[1.5rem] bg-pearl p-5 text-left text-sm">
            ...
            <Info label="Trạng thái thanh toán" value={order?.paymentStatus === "paid" ? "Đã thanh toán" : "Chờ thanh toán"} />
