...
export const getAdminProductVideos = cache(async function getAdminProductVideos() {
...
export const getProductVideos = cache(async function getProductVideos(productId: string) {
  if (hasSupabaseEnv && supabase) {
...
export const getFeaturedVideos = cache(async function getFeaturedVideos() {
  if (hasSupabaseEnv && supabase) {
